...
<td align="center"><input type = "text" name = "username" size="30" placeholder="Username" required="required" /></td>
</tr>
<tr>
<td align="center"><input type = "password" name = "pass" size="30" placeholder="Password" required="required" /></td>
</tr>
<tr><td align="center" style="color:red">
<?php if(isset($_SESSION['LogIn'])) { echo $_SESSION['LogIn']['error']; }?></td></tr>
<tr>
<tr>
