...
<td style="color:red" align="center"><input type = "password" name = "curpass" size="30"> *<br>
<?php echo $curpassErr;?></td>
</tr>
<tr>
<td>New Password: </td>
<td style="color:red" align="center"><input type = "password" name = "newpass" size="30"> *<br>
<?php echo $newpassErr;?></td>
</tr>
<tr>
<td>Confirm Password</td>
<td style="color:red" align="center"><input type = "password" name = "conpass" size="30"> *<br>
